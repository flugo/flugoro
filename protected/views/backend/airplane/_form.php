...
<div class="row">
    <div class="col-lg-6">
        <div class="form-group">
            <?php echo $form->labelEx($model,'airplaneid'); ?>
            <?php echo $form->textField($model,'airplaneid',array('class' => 'form-control')); ?>
            <?php echo $form->error($model,'airplaneid'); ?>
        </div>
        ...
        <div class="form-group">
            <?php echo $form->labelEx($model,'slug'); ?> &nbsp;<span><i class="glyphicon glyphicon-warning-sign"></i> Baza: <?php echo Yii::app()->request->baseUrl; ?>/ro/avioane/</span>
