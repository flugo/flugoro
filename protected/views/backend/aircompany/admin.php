...
$('.search-form form').submit(function(){
	$('#aircompany-desc-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h3>Administrare descrieri companii aeriene</h3>
...
<?php echo CHtml::link('Cautare Avansata','#',array('class'=>'search-button')); ?>
