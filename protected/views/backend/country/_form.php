...
<div class="row">
    <div class="col-lg-6">
        <div class="form-group">
            ...
            <?php echo $form->textField($model,'countryid',array('class' => 'form-control')); ?>
        ...
        <div class="form-group">
            <?php echo $form->labelEx($model,'slug'); ?> &nbsp;<span><i class="glyphicon glyphicon-warning-sign"></i> Baza: <?php echo Yii::app()->request->baseUrl; ?>/ro/tari/</span>
